    ...
    <div>
        <main>
            <div id="hero" className='min-h-screen bg-linear-to-br from-purple-50 via-orange-50 to-transparent'>
                ...
                <div id="hero-container" className='max-w-4xl mx-auto px-6 pt-6 pb-32 flex flex-col'>
                    {/* VERSION BOX */}
                    ...
                    <div id="buttons-container" className='mt-12 flex flex-col sm:flex-row gap-4'>
                        ...
                        <button className='bg-white font-semibold px-8 py-3 rounded-lg border border-gray-300'>Read Docs</button>
                    </div>
                </div>
